    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "EmailAdress", "IsActive", "Password", "UserName", "UserProfileId" },
                values: new object[] { 1, null, false, "Luke123", "Luke", 0 });

            migrationBuilder.InsertData(
                table: "UserProfile",
                columns: new[] { "Id", "FirstName", "LastName", "PersonalNumber" },
                values: new object[] { 1, null, null, "01010039867" });
        }
